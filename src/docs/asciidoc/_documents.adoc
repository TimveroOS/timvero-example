...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/participant/ParticipantDocumentTypesConfiguration.java[lines=23..33]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/participant/ParticipantDocumentTypesConfiguration.java[lines=35..38]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/participant/ParticipantDocumentTypesConfiguration.java[lines=20..21]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/participant/tab/ParticipantDocumentsTab.java[]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/participant/ParticipantDocumentTypesConfiguration.java[lines=21..25]
----
