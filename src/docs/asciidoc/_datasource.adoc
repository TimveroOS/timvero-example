...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/risk/github/GithubDataSource.java[lines=15..22]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/risk/github/GithubDataSource.java[lines=34..48]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/risk/github/GithubDataSource.java[lines=50..53]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/risk/github/GithubDataSourceSubject.java[lines=1..10]
----
...
[source,java]
----
include::{sourcedir}/com/timvero/example/admin/risk/github/GithubUser.java[lines=1..15]
----
