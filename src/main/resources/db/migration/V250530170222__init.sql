    ...
    create table aud_client (
        id uuid not null,
        rev integer not null,
        revtype smallint,
        contact_info_email varchar(255),
        contact_info_phone varchar(255),
        individual_info_date_of_birth date,
        individual_info_full_name varchar(255),
        individual_info_national_id varchar(255),
        individual_info_residence_country varchar(255),
        primary key (rev, id)
    );
    ...
    create table aud_participant (
        id uuid not null,
        rev integer not null,
        revtype smallint,
        employment varchar(255),
        how_often_income_is_paid varchar(255),
    ...
    create table client (
        ...
        contact_info_phone varchar(255) not null,
        individual_info_date_of_birth date,
        individual_info_full_name varchar(255) not null,
        individual_info_national_id varchar(255) not null,
        individual_info_residence_country varchar(255) not null,
        created_by uuid,
        updated_by uuid,
        primary key (id)
    );
    ...
    alter table if exists application 
       drop constraint if exists UKo0gajojgja6ij2djkw5uth1he;

    alter table if exists application 
       add constraint UKo0gajojgja6ij2djkw5uth1he unique (borrower_participant_id);
    ...
    alter table if exists application 
       add constraint FKjsr7j6asr97kj7dvgiocvs3b9 
       foreign key (created_by) 
       references auditor;

    alter table if exists application 
       add constraint FKl8dx0na2c6wcfb3jcoxxn8w9u 
       foreign key (updated_by) 
       references auditor;

    alter table if exists application 
       add constraint FKgos9xykb3vnr0ht4px679n0hb 
       foreign key (borrower_participant_id) 
       references participant;

    alter table if exists aud_application 
       add constraint FKenl7ycqxll7cw7ekr3sqyweg4 
       foreign key (rev) 
       references aud;
    ...
    alter table if exists aud_client 
       add constraint FK9haf5cw1b2pwcxe4l23kehflj 
       foreign key (rev) 
       references aud;
    ...
    alter table if exists aud_participant 
       add constraint FKb5x9ek9oofbfpudb6jshsky8 
       foreign key (rev) 
       references aud;
    ...
    alter table if exists client 
       add constraint FK58euyep8nnhqunue6u8blod39 
       foreign key (created_by) 
       references auditor;

    alter table if exists client 
       add constraint FK7qwii90b36soh9tr6w25bq560 
       foreign key (updated_by) 
       references auditor;
    ...
    alter table if exists participant 
       add constraint FKk3jgv1a3vm7ocpkeidndg2sw2 
       foreign key (created_by) 
       references auditor;

    alter table if exists participant 
       add constraint FK4xrcm2m59dg1e0q0uoa5xv39y 
       foreign key (updated_by) 
       references auditor;
